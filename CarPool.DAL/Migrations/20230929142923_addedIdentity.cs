        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedCarId = table.Column<Guid>(type: "char(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PassengersId = table.Column<Guid>(type: "char(36)", nullable: false),
                    RidesTakingId = table.Column<Guid>(type: "char(36)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserRide", x => new { x.PassengersId, x.RidesTakingId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserRide_AspNetUsers_PassengersId",
                        column: x => x.PassengersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserRide_Rides_RidesTakingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserRide_RidesTakingId",
